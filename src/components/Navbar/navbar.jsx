...
import './navbar.css';
import {Link} from 'react-router-dom' // Assuming you are using a separate CSS file for styles
...
const Navbar = () => {
  return (
    <div className="navbar">
      ...
      <button className="login-button"><Link to="/login" style={{textDecoration:'none', color:'red'}}>Login</Link></button>
    </div>
  );
};
